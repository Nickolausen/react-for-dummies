...
export default function Footer() {
    return <footer className="py-5 container-fluid bg-black d-flex justify-content-center align-items-center text-white">
        <div className="w-75">
            <div className="row">
                <div className="col-12 col-lg-6 text-center text-md-start">
                    ...
                    <p className='py-2 d-flex gap-2 flex-nowrap'>
